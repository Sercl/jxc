    ...
    <div>
        <div style="margin: 25px">
            ...
            <div style="margin-top:25px">
                ...
                <div class="flex-z">
                    <div v-for="(item,index) in why" :key="index" class="flex-h" style="align-items: center;">
        ...
        <div style="margin: 25px;padding:0px" class="sucdata">
            <swiper :options="swiperOption">
                <swiper-slide v-for="(slide, index) in caseLogo" :key="index" class="swiper-slide red-slide swiper-slide-prev">
                    <div style="display: flex; flex-wrap: nowrap;justify-content: flex-start;">
                        <div v-for="(value,ind) in slide" :key="ind" style="width: 50px;margin: 6px 0 6px 12px;">
                            <img width="40px" height="40px" :src="value" alt="">
                        </div>
                    </div>
                </swiper-slide>
            ...
            <swiper :options="swiperOption">
                <swiper-slide v-for="(slide, index) in caseLogoData" :key="index" class="swiper-slide red-slide swiper-slide-prev">
                    <div style="display: flex; flex-wrap: nowrap;justify-content: flex-start;">
                        <div v-for="(value,ind) in slide" :key="ind" style="width: 50px;margin: 6px 0 6px 12px;">
                            <img width="40px" height="40px" :src="value" alt="">
                        </div>
